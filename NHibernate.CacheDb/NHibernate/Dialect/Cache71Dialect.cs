...
//		DefaultProperties[Environment.STATEMENT_BATCH_SIZE, NO_BATCH];
            ...
            RegisterFunction
                ("current_timestamp", new ConditionalParenthesisFunction("current_timestamp", NHibernateUtil.Timestamp));
            ...
            RegisterFunction("dateadd", new VarArgsSQLFunction(NHibernateUtil.Timestamp, "dateadd(", ",", ")"));
            ...
            RegisterFunction("now", new StandardSQLFunction("monthname", NHibernateUtil.Timestamp));
            ...
            RegisterFunction("sysdate", new NoArgSQLFunction("sysdate", NHibernateUtil.Timestamp, false));
        ...
        public bool SupportsForUpdateOf()
        {
